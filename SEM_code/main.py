...
class Fond(Ui_Fond):
	def setupUi(self, main):
		...
		try:
			...
			font.setPointSize(int(geometry['Fond']['FontcomboBoxSearch']))
			self.comboBoxSearch.setFont(font)
			font.setPointSize(int(geometry['Fond']['FontcomboBoxSearch_2']))
		...
		try:
			...
			self.comboBoxSearch.setStyleSheet(str(styleSheets['Fond']['comboBoxSearch']))
			...
			self.comboBoxSearch_2.setStyleSheet(str(styleSheets['Fond']['comboBoxSearch_2']))
